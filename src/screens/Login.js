...
import { View, Text, StyleSheet, SafeAreaView, TextInput, Image, TouchableOpacity, Platform } from 'react-native';
            ...
            <View style={styles.container}>
                ...
                <View style={{ paddingHorizontal: "5%" }}>
                    ...
                    <View style={{marginTop: 15, alignItems:'flex-end' }}>
                        <Text style={{color: "#F6921E", fontSize: 12}}>Forgot Password?</Text>
                    </View>
